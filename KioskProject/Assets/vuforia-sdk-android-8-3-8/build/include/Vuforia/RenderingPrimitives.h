...
public:
    ...
    /// Get the effective field of view for the specified VIEW. (DEPRECATED)
    /**
    ...
    /// Get any skew adjustments that need to be applied to the projection matrix before rendering. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     *
    ...
    /// Get the size of a texture that can be used to render undistorted content for stereo applications. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     *
    ...
    /// Get the viewport for the given VIEW to use when rendering the distortion mesh. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     *
    ...
    /// Get a distortion mesh for the given view. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     *
