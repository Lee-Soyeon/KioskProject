...
public:
    ...
    /// Enum used in setting the rendering mode. (DEPRECATED)
    /**
     * \deprecated This enum has been deprecated. It will be removed in an
    ...
    /// Set the rendering mode. (DEPRECATED)
    /**
    ...
    /// Get the current rendering mode. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     */
    ...
    /// Activate or deactivate the selected viewer. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     *
    ...
    /// Returns true if a viewer is active, false otherwise. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     */
    ...
    /// Get the list of ViewerParameters known to the system. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     */
    ...
    /// Select the viewer to use. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     *
    ...
    /// Get the ViewerParameters for the currently selected viewer. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     */
