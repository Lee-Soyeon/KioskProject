...
public:
    ...
    /// Get whether this eyewear device has a display for each eye (i.e. stereo). (DEPRECATED)
    /**
    ...
    /// Set whether the display surface is extended over both eyes, or duplicated. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     *
    ...
    /// Get whether the display surface is extended over both eyes. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     *
    ...
    /// Returns true if the Eyewear device dual display mode is only for OpenGL content. (DEPRECATED)
    /**
     *  \deprecated This method has been deprecated. It will be removed in an
     *  upcoming %Vuforia release.
     *
    ...
    /// Turn predictive tracking on or off. (DEPRECATED)
    /**
     *  \deprecated This method has been deprecated. It will be removed in an
     *  upcoming %Vuforia release.
     *
    ...
    /// Get whether predictive tracking is enabled. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     */
    ...
    /// Get the calibration profile manager. (DEPRECATED)
    /**
     * \deprecated This method has been deprecated. It will be removed in an
     * upcoming %Vuforia release.
     *
