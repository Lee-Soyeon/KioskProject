...
public class GoogleVoiceSpeech : MonoBehaviour {
	...
	void Start () {
        textBox = GameObject.Find("Text_STT").GetComponent<Text>();
		...
		if(micConnected)
		{
			...
			else //Recording is in progress
			{
				...
				if(GUI.Button(new Rect(Screen.width/2-100, Screen.height/2-25, 200, 50), "Stop and Play!"))
				{
					...
					string apiURL = "https://speech.googleapis.com/v1/speech:recognize?&key=AIzaSyB0c4eMZ68z3CzAkjdZXlxiRg_db_y_FmY";
					string Response;
